  ...
  return (
    <div className="fixed bottom-4 left-4 z-40 hidden md:block max-w-xs">
      <div 
        ...
        className="relative bg-white/95 backdrop-blur-md border border-stone-200 shadow-xl shadow-stone-900/10 p-3 rounded-2xl flex items-center gap-3 cursor-pointer hover:border-[#62c110] transition-all hover:scale-[1.02] group"
      >
        <button
          onClick={(e) => {
            e.stopPropagation();
        ...
        {/* Clean Styled Initial Badge (No AI icons) */}
        <div className="w-10 h-10 rounded-2xl bg-[#07221a] text-[#62c110] font-black flex items-center justify-center text-base border border-[#164c3c] shadow-xs shrink-0">
          {currentItem.initial}
        </div>
        ...
        <div className="space-y-0.5 text-left text-xs">
          <div className="flex items-center gap-1 text-stone-900 font-bold">
            ...
            <CheckCircle2 className="w-3.5 h-3.5 text-[#16a34a] ml-auto shrink-0" />
          </div>

          <p className="text-[11px] text-stone-600 font-medium line-clamp-1 group-hover:text-[#07221a] transition-colors">
